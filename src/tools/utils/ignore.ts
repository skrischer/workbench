 ...
 */
export function shouldIgnore(name: string, ignoreList: string[]): boolean {
...
export interface WalkOptions {
  ...
  depth?: number;
  /** Additional patterns to ignore beyond defaultIgnores */
  ignore?: string[];
  /** Current depth (internal use for recursion) */
...
export interface WalkEntry {
  ...
  /** Type of entry */
  type: 'file' | 'directory';
  /** Depth level from the starting point */
  depth: number;
}
